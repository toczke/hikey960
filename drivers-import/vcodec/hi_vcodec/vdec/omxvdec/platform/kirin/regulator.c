...
#endif   //for struct iommu_domain_data
...
static inline HI_S32 VDEC_Enable_Iommu(struct device *dev) { return HI_SUCCESS; }
static inline HI_VOID VDEC_Disable_Iommu(struct device *dev) { }
#endif
