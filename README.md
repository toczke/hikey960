...
| **Video Codec** (VPU/hi_vcodec) | `[BUILDS ONLY, UNTESTED]` | Driver source (`hi_vcodec`) present. Device Tree nodes for `vdec@e8800000` / `venc@e8900000` written in `patches/0007-hikey960-vpu-node.patch` (Phase 2). Source audit completed (`docs/10-VPU_SOURCE_AUDIT.md`). Hardware probe verification underway on `feature/kirin960-vpu-1080p`. See `docs/07-MULTIMEDIA_AND_GPU.md §3`. |
