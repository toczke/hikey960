...
if [ "$MODE" = "1920,1080" ]; then
  ...
  # ADV7535 CEC Timing Generator: 1080p (chip confirmed ADV7535 by DTS compatible = "adi,adv7535","adi,adv7533")
  # htotal=2200 (0x898)
...
# Common ADV7535 CEC/DSI-side settings (chip is ADV7535; DTS compatible = "adi,adv7535","adi,adv7533")
